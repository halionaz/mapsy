...
{
  echo "/**"
  echo " * Constraints in the \`public\` schema — names, and what they check."
  echo " *"
  ...
  echo " * The definitions carry the *values*: the form mirrors several ceilings so a"
  echo " * violation is caught before five photos have uploaded, and limits.test.ts"
  echo " * asserts each mirror still matches. Names alone did not catch that —"
  echo " * \`items_price_max\` drifted with its name intact."
  echo " */"
